...
fun CentralContent(
    ...
    Image(
        modifier = Modifier
            ...
            .size(120.dp),
        painter = painterResource(id = com.example.googleauthapp.R.drawable.ic_google_logo),
        contentDescription = "Google Logo"
    )
    Text(
        text = stringResource(id = com.example.googleauthapp.R.string.sign_in_title),
    ...
    Text(
        ...
        text = stringResource(id = com.example.googleauthapp.R.string.sign_in_subtitle),
